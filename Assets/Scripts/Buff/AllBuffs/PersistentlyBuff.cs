...
public class PersistentlyBuff : BasePersistentlyBuff
{
    /// <summary>
    /// 持续性的增益效果
    /// </summary>
    ...
    public PersistentlyBuff(PlayerStatsManager playerStatsManager,
    eBuffType buffType,
    ...
    float effectInterval)
    {
        ...
        this.buffValue = 1;
        this.isActive = true;
        Debug.Log("Add Buff: Affect " + this.affectAttribute.ToString() + "for" + this.duration + "s");
    }
