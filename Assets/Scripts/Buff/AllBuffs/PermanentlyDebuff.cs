...
public class PermanentlyDebuff : BasePermanentBuff
{
    /// <summary>
    /// 永久性保持的增益效果
    /// </summary>
    ...
    public PermanentlyDebuff(PlayerStatsManager playerStatsManager,
    eBuffType buffType,
    ...
    float duration)
    {
        ...
        Debug.Log("Add Debuff: Affect " + this.affectAttribute.ToString());
    }
